...
table1.df$CategoryF <- factor(table1.df$Category, levels = c("Demographic", "Comorbidities","Vaccination", "Covid-19 treatment", "IMID type", "Drug type", "Geocoding"))
...
pdf("Fig3_no_mAbs_wPts.pdf", width = 22, height = 25)
